...
const LARGE_PLUGIN_TEST_TIMEOUT_MS = IS_STRICT_PERFORMANCE_TEST
  ? STRICT_LARGE_PLUGIN_FORMAT_TIMEOUT_MS + PERFORMANCE_TEST_TIMEOUT_BUFFER_MS
  : CATASTROPHIC_LARGE_PLUGIN_TEST_TIMEOUT_MS;
